...
import 'package:center/view/login/tru_signup_view.dart';
import 'package:flutter/material.dart';
// Import the Dropdown widget file

class TruckLoginView extends StatefulWidget {
  const TruckLoginView({super.key});

  @override
  State<TruckLoginView> createState() => _TruckLoginViewState();
}

class _TruckLoginViewState extends State<TruckLoginView> {
                   ...
                   icon: Icon(
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(
                          onPressed: () {
                             Navigator.push(context,MaterialPageRoute(builder: (context)=>const TruckSignUpView()));
                          },
                          child: Row(
